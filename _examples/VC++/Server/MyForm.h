...
#pragma region Windows Form Designer generated code
		private:
			...
			void InitializeComponent(void)
			{
				...
				this->button2->Text = L"Stop Server";
				...
				this->button3->Text = L"Start Server";
				...
				this->label2->Text = L"Broadcast Message:";
				// 
				// textBox1
				// 
				this->textBox1->Location = System::Drawing::Point(122, 317);
...
#pragma endregion
		...
		public:
			static void OnConnect(void *self, unsigned int aPipe);
